...
``	场景中的对白显示框需命名为 _dialog，并且只能有一个
	...
	*/
	public class AcgScene_130728 extends MovieClip
	{
		//-----静态常量-----
		...
		//------构造函数----
		public function AcgScene_130728()
		{
		...
		private function onLineTimer(evt:TimerEvent):void
		{
			...
			_dialog.text += (_curLineStr.charAt(_curLinePos));
